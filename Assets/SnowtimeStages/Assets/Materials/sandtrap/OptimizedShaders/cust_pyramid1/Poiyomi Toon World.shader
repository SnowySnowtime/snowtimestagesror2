Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/61ebf4839ca9e7248900b955a82c0d96"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (0.0 /*_RGBAPBRAlphaEnabled*/))
				{
					#if defined(PROP_RGBASMOOTHNESSMAPS) || !defined(OPTIMIZER_ENABLED)
					float4 smoothnessMaps = 1;
					if (!(1.0 /*_RGBARedPBRSplitMaskSample*/) || !(0.0 /*_RGBAGreenPBRSplitMaskSample*/) || !(0.0 /*_RGBABluePBRSplitMaskSample*/) || !(0.0 /*_RGBAAlphaPBRSplitMaskSample*/))
					{
					...
					if ((1.0 /*_RGBARedPBRSplitMaskSample*/) && (1.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/))
					{
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.r, (0.0 /*_RGBARedMetallicInvert*/)), rgbMask[(1.0 /*_RgbRedMaskChannel*/)] * ((1.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/)));
