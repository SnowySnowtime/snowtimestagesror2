Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/d2b49fdf755460c44820d6f44eeda810"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (2.0 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (0.61 /*_DetailTexIntensity*/));
			}
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(1,1,0,0)), float4(0,10,0,0), (1.0 /*_DetailNormalMapStochastic*/)), (1.0 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
				if ((0.25 /*_RgbNormalRScale*/) > 0 && (1.0 /*_RGBARedEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalRUV*/)], float4(95,95,0,0)), float4(0,0,0,0), (1.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRedBlendMode*/) == 0 ? (0.25 /*_RgbNormalRScale*/) : (0.25 /*_RgbNormalRScale*/) * maskFinal.r);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.r, (1.0 /*_RgbNormalRedBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALG) || !defined(OPTIMIZER_ENABLED)
				if ((0.25 /*_RgbNormalGScale*/) > 0 && (1.0 /*_RGBAGreenEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalG, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalGUV*/)], float4(4,4,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalGStochastic*/)), (1.0 /*_RgbNormalGreenBlendMode*/) == 0 ? (0.25 /*_RgbNormalGScale*/) : (0.25 /*_RgbNormalGScale*/) * maskFinal.g);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.g, (1.0 /*_RgbNormalGreenBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALB) || !defined(OPTIMIZER_ENABLED)
				if ((0.25 /*_RgbNormalBScale*/) > 0 && (1.0 /*_RGBABlueEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalB, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalBUV*/)], float4(25,25,0,0)), float4(0,0,0,0), (1.0 /*_RgbNormalBStochastic*/)), (1.0 /*_RgbNormalBlueBlendMode*/) == 0 ? (0.25 /*_RgbNormalBScale*/) : (0.25 /*_RgbNormalBScale*/) * maskFinal.b);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.b, (1.0 /*_RgbNormalBlueBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALA) || !defined(OPTIMIZER_ENABLED)
				if ((0.5 /*_RgbNormalAScale*/) > 0 && (1.0 /*_RGBAAlphaEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalA, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalAUV*/)], float4(300,300,0,0)), float4(0,100,0,0), (1.0 /*_RgbNormalAStochastic*/)), (1.0 /*_RgbNormalAlphaBlendMode*/) == 0 ? (0.5 /*_RgbNormalAScale*/) : (0.5 /*_RgbNormalAScale*/) * maskFinal.a);
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float4 blue = float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_BlueColorThemeIndex*/)), float4(0,0,0,1).a);
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(200,200,0,0)), float4(0,0,0,0).xy, (1.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				green *= POI2D_SAMPLER_PAN_STOCHASTIC(_GreenTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_GreenTextureUV*/)], float4(200,200,0,0)), float4(0,0,0,0).xy, (1.0 /*_GreenTextureStochastic*/));
				#endif
				#if defined(PROP_BLUETEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				#if defined(PROP_ALPHATEXTURE) || !defined(OPTIMIZER_ENABLED)
				alpha *= POI2D_SAMPLER_PAN_STOCHASTIC(_AlphaTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_AlphaTextureUV*/)], float4(20,20,0,0)), float4(0,10,0,0).xy, (1.0 /*_AlphaTextureStochastic*/));
				#endif
				...
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbGreenMaskChannel*/)], (0.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (0.0 /*_RGBAGreenBlendType*/), (0.0 /*_GreenAlphaAdd*/), (1.0 /*_RGBAGreenEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbBlueMaskChannel*/)], (0.0 /*_RgbBlueGlobalMaskChannel*/), (2.0 /*_RgbBlueGlobalMaskBlendType*/), poiMods), blue, (0.0 /*_RGBABlueEmissionStrength*/), (8.0 /*_RGBABlueBlendType*/), (0.0 /*_BlueAlphaAdd*/), (1.0 /*_RGBABlueEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(3.0 /*_RgbAlphaMaskChannel*/)], (0.0 /*_RgbAlphaGlobalMaskChannel*/), (2.0 /*_RgbAlphaGlobalMaskBlendType*/), poiMods), alpha, (0.0 /*_RGBAAlphaEmissionStrength*/), (9.0 /*_RGBAAlphaBlendType*/), (-0.8 /*_AlphaAlphaAdd*/), (1.0 /*_RGBAAlphaEnable*/));
				if ((0.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (0.0 /*_RGBAPBRAlphaEnabled*/))
				{
					...
					{
						smoothnessMaps.r = POI2D_SAMPLER_PAN_STOCHASTIC(_RGBASmoothnessMaps, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RGBARedPBRUV*/)], float4(70,70,0,4)), float4(0,0,0,0).xy, (1.0 /*_RGBARedPBRSplitMaskStochastic*/)).r;
					}
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.g, (0.0 /*_RGBAGreenSmoothnessInvert*/)), rgbMask[(2.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/)));
					...
					if ((0.0 /*_RGBARedPBRSplitMaskSample*/) && (0.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/))
					{
						metallicMaps.r = POI2D_SAMPLER_PAN_STOCHASTIC(_RGBAMetallicMaps, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RGBARedPBRUV*/)], float4(70,70,0,4)), float4(0,0,0,0).xy, (1.0 /*_RGBARedPBRSplitMaskStochastic*/)).r;
					}
					if ((0.0 /*_RGBAGreenPBRSplitMaskSample*/) && (0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/))
					{
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.g, (0.0 /*_RGBAGreenMetallicInvert*/)), rgbMask[(2.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/)));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(100,100,0,0));
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(20,20,0,0)), float4(0,10,0,0), (1.0 /*_BumpMapStochastic*/)), (0.4 /*_BumpScale*/));
				#else
