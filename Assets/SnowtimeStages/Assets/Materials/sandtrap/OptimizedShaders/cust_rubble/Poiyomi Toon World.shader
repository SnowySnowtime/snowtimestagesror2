Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/9b1f70fd8e8d371459b3b58b65950bf7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(100,100,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (2.0 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (0.4 /*_DetailTexIntensity*/));
			}
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float4 alpha = float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_AlphaColorThemeIndex*/)), float4(0,0,0,1).a);
				#if defined(PROP_RGBMASK) || !defined(OPTIMIZER_ENABLED)
				if ((0.0 /*_RGBMaskType*/) == 0)
				{
					rgbMask = POI2D_SAMPLER_PAN(_RGBMask, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RGBMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(5,5,0,0)), float4(0,0,0,0).xy, (0.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				green *= POI2D_SAMPLER_PAN_STOCHASTIC(_GreenTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_GreenTextureUV*/)], float4(100,100,0,0)), float4(0,0,0,0).xy, (0.0 /*_GreenTextureStochastic*/));
				#endif
				#if defined(PROP_BLUETEXTURE) || !defined(OPTIMIZER_ENABLED)
				blue *= POI2D_SAMPLER_PAN_STOCHASTIC(_BlueTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_BlueTextureUV*/)], float4(30,30,0,0)), float4(0,0,0,0).xy, (0.0 /*_BlueTextureStochastic*/));
				#endif
				#if defined(PROP_ALPHATEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(1.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (0.0 /*_RGBARedBlendType*/), (0.0 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(1.0 /*_RgbGreenMaskChannel*/)], (0.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (20.0 /*_RGBAGreenBlendType*/), (0.0 /*_GreenAlphaAdd*/), (1.0 /*_RGBAGreenEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbBlueMaskChannel*/)], (0.0 /*_RgbBlueGlobalMaskChannel*/), (2.0 /*_RgbBlueGlobalMaskBlendType*/), poiMods), blue, (0.0 /*_RGBABlueEmissionStrength*/), (0.0 /*_RGBABlueBlendType*/), (0.75 /*_BlueAlphaAdd*/), (1.0 /*_RGBABlueEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(1.0 /*_RgbAlphaMaskChannel*/)], (0.0 /*_RgbAlphaGlobalMaskChannel*/), (2.0 /*_RgbAlphaGlobalMaskBlendType*/), poiMods), alpha, (0.0 /*_RGBAAlphaEmissionStrength*/), (0.0 /*_RGBAAlphaBlendType*/), (0.0 /*_AlphaAlphaAdd*/), (0.0 /*_RGBAAlphaEnable*/));
				if ((1.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (1.0 /*_RGBAPBRAlphaEnabled*/))
				{
					#if defined(PROP_RGBASMOOTHNESSMAPS) || !defined(OPTIMIZER_ENABLED)
					...
					if ((0.0 /*_RGBARedPBRSplitMaskSample*/) && (1.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/))
					{
						smoothnessMaps.r = POI2D_SAMPLER_PAN_STOCHASTIC(_RGBASmoothnessMaps, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RGBARedPBRUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy, (1.0 /*_RGBARedPBRSplitMaskStochastic*/)).r;
					}
					...
					if ((0.0 /*_RGBAAlphaPBRSplitMaskSample*/) && (1.0 /*_RGBAPBRAlphaEnabled*/) && (0.0 /*_RGBAAlphaEnable*/))
					{
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.r, (0.0 /*_RGBARedSmoothnessInvert*/)), rgbMask[(1.0 /*_RgbRedMaskChannel*/)] * ((1.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/)));
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.a, (0.0 /*_RGBAAlphaSmoothnessInvert*/)), rgbMask[(1.0 /*_RgbAlphaMaskChannel*/)] * ((1.0 /*_RGBAPBRAlphaEnabled*/) && (0.0 /*_RGBAAlphaEnable*/)));
					#endif
					#if defined(PROP_RGBAMETALLICMAPS) || !defined(OPTIMIZER_ENABLED)
					...
					if ((0.0 /*_RGBARedPBRSplitMaskSample*/) && (1.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/))
					{
						metallicMaps.r = POI2D_SAMPLER_PAN_STOCHASTIC(_RGBAMetallicMaps, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RGBARedPBRUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy, (1.0 /*_RGBARedPBRSplitMaskStochastic*/)).r;
					}
					if ((0.0 /*_RGBAGreenPBRSplitMaskSample*/) && (0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/))
					{
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.r, (1.0 /*_RGBARedMetallicInvert*/)), rgbMask[(1.0 /*_RgbRedMaskChannel*/)] * ((1.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/)));
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.g, (1.0 /*_RGBAGreenMetallicInvert*/)), rgbMask[(1.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/)));
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.b, (1.0 /*_RGBABlueMetallicInvert*/)), rgbMask[(2.0 /*_RgbBlueMaskChannel*/)] * ((0.0 /*_RGBAPBRBlueEnabled*/) && (1.0 /*_RGBABlueEnable*/)));
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.a, (0.0 /*_RGBAAlphaMetallicInvert*/)), rgbMask[(1.0 /*_RgbAlphaMaskChannel*/)] * ((1.0 /*_RGBAPBRAlphaEnabled*/) && (0.0 /*_RGBAAlphaEnable*/)));
					#endif
				}
			}
			#endif
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.75 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(10,10,0,0));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.9386859,0.6104956,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0.9386859,0.6104956,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - ((-0.35 /*_Saturation*/)) * hueShiftAlpha.b);
