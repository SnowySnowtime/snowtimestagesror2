Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/976909289a31dfd4fab62d0b5e57e5ff"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalApplyGlobalMaskIndex = (2.0 /*_Decal0ApplyGlobalMaskIndex*/);
				Decal0.m_DecalApplyGlobalMaskBlendType = (2.0 /*_Decal0ApplyGlobalMaskBlendType*/);
				...
				Decal2.m_DecalApplyGlobalMaskIndex = (2.0 /*_Decal2ApplyGlobalMaskIndex*/);
				Decal2.m_DecalApplyGlobalMaskBlendType = (2.0 /*_Decal2ApplyGlobalMaskBlendType*/);
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(24,24,0,0)), float4(0.1,0.1,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(24,24,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				...
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
				float emissionMask1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMask1UV*/)], float4(1,1,0,0.25)) + _Time.x * float4(0,0,0,0))[(0.0 /*_EmissionMask1Channel*/)];
				#else
