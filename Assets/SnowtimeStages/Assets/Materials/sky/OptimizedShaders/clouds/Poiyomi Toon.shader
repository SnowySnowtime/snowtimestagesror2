Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/b3ab204e225b0cd408e05bc05455416c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISTORTIONFLOWTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector = POI2D_SAMPLER_PAN(_DistortionFlowTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DistortionFlowTextureUV*/)], float4(32,32,0,0)), float4(1,1,0,0)) * 2 - 1;
				#else
				float4 flowVector = -1;
				#endif
				#if defined(PROP_DISTORTIONFLOWTEXTURE1) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector1 = POI2D_SAMPLER_PAN(_DistortionFlowTexture1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DistortionFlowTexture1UV*/)], float4(5,5,0,0)), float4(-0.75,0,0,0)) * 2 - 1;
				#else
				...
				#endif
				half distortionStrength = (0.02 /*_DistortionStrength*/);
				half distortionStrength1 = (0.03 /*_DistortionStrength1*/);
				#ifdef POI_AUDIOLINK
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalTexture_ST = float4(3,3,0,0);
				Decal0.m_DecalTexturePan = float4(0.1,0,0,0);
				Decal0.m_DecalTextureUV = (0.0 /*_DecalTextureUV*/);
				Decal0.m_DecalColor = float4(0.8713672,0.8713672,0.8713672,1);
				...
				Decal1.m_DecalTexture_ST = float4(6,6,0,0);
				Decal1.m_DecalTexturePan = float4(0.3,0,0,0);
				Decal1.m_DecalTextureUV = (0.0 /*_DecalTexture1UV*/);
				Decal1.m_DecalColor = float4(0.8713672,0.8713672,0.8713672,1);
				Decal1.m_DecalColorThemeIndex = (0.0 /*_DecalColor1ThemeIndex*/);
				Decal1.m_DecalTiled = (0.0 /*_DecalTiled1*/);
				Decal1.m_DecalBlendType = (20.0 /*_DecalBlendType1*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((0.0 /*_MainAlphaMaskMode*/))
				{
					...
					if ((0.0 /*_MainAlphaMaskMode*/) == 1) poiFragData.alpha = alphaMask;
					if ((0.0 /*_MainAlphaMaskMode*/) == 2) poiFragData.alpha = poiFragData.alpha * alphaMask;
					if ((0.0 /*_MainAlphaMaskMode*/) == 3) poiFragData.alpha = saturate(poiFragData.alpha + alphaMask);
					if ((0.0 /*_MainAlphaMaskMode*/) == 4) poiFragData.alpha = saturate(poiFragData.alpha - alphaMask);
				}
				#endif
