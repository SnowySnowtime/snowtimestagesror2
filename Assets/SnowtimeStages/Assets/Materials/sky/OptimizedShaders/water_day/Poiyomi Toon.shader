Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ce47f416c5bf401498d04de27f65461b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(64,128,0,0)), float4(1,0,0,0), (1.0 /*_DetailNormalMapStochastic*/)), (0.15 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
				if ((0.15 /*_RgbNormalRScale*/) > 0 && (1.0 /*_RGBARedEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalRUV*/)], float4(512,512,0,0)), float4(1,1,0,0), (1.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRedBlendMode*/) == 0 ? (0.15 /*_RgbNormalRScale*/) : (0.15 /*_RgbNormalRScale*/) * maskFinal.r);
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float4 red = float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_RedColorThemeIndex*/)), float4(0,0,0,1).a);
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy, (1.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(1.0 /*_RgbGreenMaskChannel*/)], (0.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (0.0 /*_RGBAGreenBlendType*/), (0.0 /*_GreenAlphaAdd*/), (0.0 /*_RGBAGreenEnable*/));
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				cubeMap.rgb *= (0.15 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.emission += cubeMap.rgb * (1.0 /*_CubeMapEmissionStrength*/) * CubeMapMask * cubeMap.a;
			}
			#endif
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness2 = (0.652 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.1 /*_MochieMetallicMultiplier*/);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((1.0 /*_MochieGSAAEnabled*/))
				{
					...
					if ((1.0 /*_Specular2ndLayer*/) == 1 && (0.5 /*_MochieSpecularStrength2*/) > 0)
					{
				...
				if ((1.0 /*_Specular2ndLayer*/) == 1)
				{
					float3 fresnelTerm = 1;
					float3 specularTerm = 1;
					GetSpecFresTerm(pbrNDotL, pbrNDotV, pbrNDotH, poiLight.lDotH, specularTerm, fresnelTerm, specCol, brdfRoughness2);
					specular2 = poiLight.directColor * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * attenuation * (0.5 /*_MochieSpecularStrength2*/);
					if (poiFragData.toggleVertexLights)
					{
						#if defined(VERTEXLIGHT_ON)
						for (int index = 0; index < 4; index++)
						{
							...
							vSpecular2 += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * (0.5 /*_MochieSpecularStrength2*/);
						}
						#endif
					}
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(768,768,0,0)), float4(1,1,0,0), (1.0 /*_BumpMapStochastic*/)), (0.15 /*_BumpScale*/));
				#else
				...
				#endif
				if ((5.0 /*_Mode*/) == POI_MODE_OPAQUE)
				{
				}
				clip(poiFragData.alpha - (0.0 /*_Cutoff*/));
				if ((5.0 /*_Mode*/) == POI_MODE_CUTOUT && !(0.0 /*_AlphaToCoverage*/))
				{
					poiFragData.alpha = 1;
				}
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((5.0 /*_Mode*/) != POI_MODE_TRANSPARENT)
				{
