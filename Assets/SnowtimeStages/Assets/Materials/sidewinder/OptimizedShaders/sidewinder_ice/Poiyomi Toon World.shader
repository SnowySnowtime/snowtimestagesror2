Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/aeb5afc23e2b5be47bc98a74cb0dca52"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
				if ((0.2 /*_RgbNormalRScale*/) > 0 && (1.0 /*_RGBARedEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalRUV*/)], float4(75,75,0,0)), float4(0,0,0,0), (1.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRedBlendMode*/) == 0 ? (0.2 /*_RgbNormalRScale*/) : (0.2 /*_RgbNormalRScale*/) * maskFinal.r);
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (8.0 /*_RGBARedBlendType*/), (0.0 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float4 cubeMap = texCUBElod(_CubeMap, float4(CubeMapUV, (1 - (0.68 /*_CubeMapSmoothness*/)) * (1 - (0.68 /*_CubeMapSmoothness*/)) * 8));
				...
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				float CubeMapMask = POI2D_SAMPLER_PAN(_CubeMapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_CubeMapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(3.0 /*_CubeMapMaskChannel*/)];
				#else
				float CubeMapMask = 1;
				#endif
				...
				CubeMapMask = min(CubeMapMask, lerp(1, poiLight.rampedLightMap, (0.75 /*_CubeMapLightMask*/)));
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness2 = (0.5 /*_MochieRoughnessMultiplier2*/);
