Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/4779e1468821a23458f296b8463672ba"
{
	Properties
	{
			...
			)
			{
				...
				if (1.0)
				{
					...
					if (windMask > 0)
					{
						...
						float primaryWave = sin(_Time.y * 1.0 + dot(worldPos, normalize(float4(1,0,0,0).xyz)) * 1.0) * turbulence;
