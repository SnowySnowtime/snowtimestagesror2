Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/e8b2a37d41d84e642b0e1978514d1374"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (3.0 /*_EmissionStrength*/);
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (5.0 /*_EmissionStrength1*/);
