Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/965cd73c7ec7ec144bcfcb4704985386"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.attenuationStrength = (0.85 /*_LightingCastedShadows*/);
				...
				poiLight.attenuationStrength = (0.85 /*_LightingAdditiveCastedShadows*/);
