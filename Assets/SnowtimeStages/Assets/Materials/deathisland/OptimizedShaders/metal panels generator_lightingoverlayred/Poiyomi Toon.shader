Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/37e72f880380f1c40989d11f5c8b6dd5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0 = emissionTex.rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(3.804896,0.3187348,0.1195255,1).rgb, 0.0);
				emissionAlpha = emissionTex.a;
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(3.804896,0.3187348,0.1195255,1).rgb, 0.0);
				#endif
			...
			void applyPathing(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float4 PathColor[4] = {
					float4(0.09960464,0.2589721,5.079837,1), float4(1,1,1,1), float4(1,1,1,1), float4(15.21959,1.274939,0.4781022,1)
				};
