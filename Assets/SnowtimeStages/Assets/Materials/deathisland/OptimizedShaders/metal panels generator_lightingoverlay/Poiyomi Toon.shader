Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/3b62b3029e10743419e8f1eb8625fa5a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0 = emissionTex.rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.08952696,0.2571092,3.804896,1).rgb, 0.0);
				emissionAlpha = emissionTex.a;
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.08952696,0.2571092,3.804896,1).rgb, 0.0);
				#endif
			...
			void applyPathing(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float4 PathColor[4] = {
					float4(0.09960464,0.2589721,5.079837,1), float4(1,1,1,1), float4(1,1,1,1), float4(0.3984185,1.035888,15.21959,1)
				};
