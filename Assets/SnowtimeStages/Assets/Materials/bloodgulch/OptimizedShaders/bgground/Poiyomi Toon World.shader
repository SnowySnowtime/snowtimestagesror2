Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/4427600509062c343b9b19de142b5865"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(180,180,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (1.3 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (1.0 /*_DetailTexIntensity*/));
			}
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				maskFinal.g = rgbMask[(2.0 /*_RgbNormalGMaskChannel*/)];
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(180,180,0,0)), float4(0,0,0,0).xy, (1.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				green *= POI2D_SAMPLER_PAN_STOCHASTIC(_GreenTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_GreenTextureUV*/)], float4(180,180,0,0)), float4(0,0,0,0).xy, (1.0 /*_GreenTextureStochastic*/));
				#endif
				#if defined(PROP_BLUETEXTURE) || !defined(OPTIMIZER_ENABLED)
				blue *= POI2D_SAMPLER_PAN_STOCHASTIC(_BlueTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_BlueTextureUV*/)], float4(180,180,0,0)), float4(0,0,0,0).xy, (1.0 /*_BlueTextureStochastic*/));
				#endif
				#if defined(PROP_ALPHATEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (6.0 /*_RGBARedBlendType*/), (0.0 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbGreenMaskChannel*/)], (0.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (9.0 /*_RGBAGreenBlendType*/), (0.0 /*_GreenAlphaAdd*/), (1.0 /*_RGBAGreenEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbBlueMaskChannel*/)], (0.0 /*_RgbBlueGlobalMaskChannel*/), (2.0 /*_RgbBlueGlobalMaskBlendType*/), poiMods), blue, (0.0 /*_RGBABlueEmissionStrength*/), (20.0 /*_RGBABlueBlendType*/), (0.0 /*_BlueAlphaAdd*/), (1.0 /*_RGBABlueEnable*/));
				...
				if ((0.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (0.0 /*_RGBAPBRAlphaEnabled*/))
				{
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.r, (0.0 /*_RGBARedSmoothnessInvert*/)), rgbMask[(2.0 /*_RgbRedMaskChannel*/)] * ((0.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/)));
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.r, (0.0 /*_RGBARedMetallicInvert*/)), rgbMask[(2.0 /*_RgbRedMaskChannel*/)] * ((0.0 /*_RGBAPBRRedEnabled*/) && (1.0 /*_RGBARedEnable*/)));
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalTexture_ST = float4(12,12,0,0);
				...
				Decal1.m_DecalTexture_ST = float4(12,12,0,0);
				...
				Decal2.m_DecalMaskChannel = (3.0 /*_Decal2MaskChannel*/);
				...
				Decal2.m_DecalBlendType = (20.0 /*_DecalBlendType2*/);
				...
				Decal3.m_DecalBlendType = (20.0 /*_DecalBlendType3*/);
