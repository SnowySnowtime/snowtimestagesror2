Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/fa6a955fd77e49a4cad7ade1b74f4c6d"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0 = emissionTex.rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.6806283,2.670157,0.6806283,1).rgb, 0.0);
				emissionAlpha = emissionTex.a;
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.6806283,2.670157,0.6806283,1).rgb, 0.0);
				#endif
			...
			float3 applyEmission__1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0__1 = emissionTex__1.rgb * lerp(1, poiFragData.baseColor, mixBaseColor__1).rgb * poiThemeColor(poiMods, float4(2,0.03335175,0,1).rgb, 0.0);
				emissionAlpha__1 = emissionTex__1.a;
				#else
				emissionColor0__1 = lerp(1, poiFragData.baseColor, mixBaseColor__1).rgb * poiThemeColor(poiMods, float4(2,0.03335175,0,1).rgb, 0.0);
				#endif
				...
				if (1.0)
				{
					emissionStrength0__1 *= calculateBlinkingEmission__1(-2.0, 2.0, 4.0, 0.0);
				}
				if(0.0)
				{
			...
			float3 applyEmission__2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0__2 = emissionTex__2.rgb * lerp(1, poiFragData.baseColor, mixBaseColor__2).rgb * poiThemeColor(poiMods, float4(2.670157,2.670157,2.670157,1).rgb, 0.0);
				emissionAlpha__2 = emissionTex__2.a;
				#else
				emissionColor0__2 = lerp(1, poiFragData.baseColor, mixBaseColor__2).rgb * poiThemeColor(poiMods, float4(2.670157,2.670157,2.670157,1).rgb, 0.0);
				#endif
				...
				if (0.0)
				{
					emissionStrength0__2 *= calculateBlinkingEmission__2(-2.0, 2.0, 4.0, 4.0);
				}
				if(0.0)
				{
