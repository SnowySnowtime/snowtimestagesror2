Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/8c8c3f122f9fcdd459f532a9caae4471"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
				if ((0.05 /*_RgbNormalRScale*/) > 0 && (1.0 /*_RGBARedEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalRUV*/)], float4(0.05,0.05,0,0)), float4(1,-0.2,0,0), (1.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRedBlendMode*/) == 0 ? (0.05 /*_RgbNormalRScale*/) : (0.05 /*_RgbNormalRScale*/) * maskFinal.r);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.r, (1.0 /*_RgbNormalRedBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALG) || !defined(OPTIMIZER_ENABLED)
				if ((0.05 /*_RgbNormalGScale*/) > 0 && (1.0 /*_RGBAGreenEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalG, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalGUV*/)], float4(0.04,0.04,0,0)), float4(1,0.5,0,0), (1.0 /*_RgbNormalGStochastic*/)), (1.0 /*_RgbNormalGreenBlendMode*/) == 0 ? (0.05 /*_RgbNormalGScale*/) : (0.05 /*_RgbNormalGScale*/) * maskFinal.g);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.g, (1.0 /*_RgbNormalGreenBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALB) || !defined(OPTIMIZER_ENABLED)
				if ((0.075 /*_RgbNormalBScale*/) > 0 && (1.0 /*_RGBABlueEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalB, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalBUV*/)], float4(0.03,0.03,0,0)), float4(-1,-1,0,0), (1.0 /*_RgbNormalBStochastic*/)), (1.0 /*_RgbNormalBlueBlendMode*/) == 0 ? (0.075 /*_RgbNormalBScale*/) : (0.075 /*_RgbNormalBScale*/) * maskFinal.b);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.b, (1.0 /*_RgbNormalBlueBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALA) || !defined(OPTIMIZER_ENABLED)
				if ((0.15 /*_RgbNormalAScale*/) > 0 && (1.0 /*_RGBAAlphaEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalA, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalAUV*/)], float4(0.05,0.015,0,0)), float4(0,0,0,0), (1.0 /*_RgbNormalAStochastic*/)), (1.0 /*_RgbNormalAlphaBlendMode*/) == 0 ? (0.15 /*_RgbNormalAScale*/) : (0.15 /*_RgbNormalAScale*/) * maskFinal.a);
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (2.0 /*_RGBARedBlendType*/), (0.0 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(1.0 /*_RgbGreenMaskChannel*/)], (0.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (2.0 /*_RGBAGreenBlendType*/), (0.0 /*_GreenAlphaAdd*/), (1.0 /*_RGBAGreenEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbBlueMaskChannel*/)], (0.0 /*_RgbBlueGlobalMaskChannel*/), (2.0 /*_RgbBlueGlobalMaskBlendType*/), poiMods), blue, (0.0 /*_RGBABlueEmissionStrength*/), (2.0 /*_RGBABlueBlendType*/), (0.0 /*_BlueAlphaAdd*/), (1.0 /*_RGBABlueEnable*/));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_MatcapUVMode*/), (5.0 /*_MatcapUVToBlend*/), float4(1,1,0,0).xy, (0.0 /*_MatcapRotation*/), (0.0 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (1.0 /*_MatcapNormal*/), matcapALD);
			...
			{
				float smoothness = (0.925 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.85 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(5.0 /*_MainTexUV*/)].xy, float4(-0.00045,0.00045,-0.555,-0.567));
