Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/dc86fa495853b7d428e5b8b43832e661"
{
	Properties
	{
 ...
 #define PROP_EMISSIONSCROLLINGCURVE2 
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (444.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(0,-0.5,0,0).xyz) * (1111.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (3.0 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-0.5,0,0).xyz, (3.0 /*_EmissiveScroll_Velocity*/), (1111.0 /*_EmissiveScroll_Interval*/), (0.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
				if ((1.0 /*_EmissionBlinkingEnabled*/))
				{
					emissionStrength0 *= calculateBlinkingEmission((-10.0 /*_EmissiveBlink_Min*/), (10.0 /*_EmissiveBlink_Max*/), (4.0 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (444.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				if ((0.0 /*_ScrollingEmission1*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE1) || !defined(OPTIMIZER_ENABLED)
						emissionStrength1 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)) + (dot(pos1, float4(0,-0.5,0,0)) * (1111.0 /*_EmissiveScroll_Interval1*/)) + _Time.x * (3.0 /*_EmissiveScroll_Velocity1*/));
						#endif
					}
					else
					{
						emissionStrength1 *= calculateScrollingEmission(float4(0,-0.5,0,0), (3.0 /*_EmissiveScroll_Velocity1*/), (1111.0 /*_EmissiveScroll_Interval1*/), (0.0 /*_EmissiveScroll_Width1*/), (0.0 /*_EmissionScrollingOffset1*/), pos1);
					}
				}
				if ((1.0 /*_EmissionBlinkingEnabled1*/))
				{
					emissionStrength1 *= calculateBlinkingEmission((-10.0 /*_EmissiveBlink_Min1*/), (10.0 /*_EmissiveBlink_Max1*/), (4.0 /*_EmissiveBlink_Velocity1*/), (4.0 /*_EmissionBlinkingOffset1*/));
				}
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (444.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(1,1,0.03529412,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				if ((0.0 /*_ScrollingEmission2*/))
				{
					...
					if ((1.0 /*_EmissionScrollingUseCurve2*/))
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE2) || !defined(OPTIMIZER_ENABLED)
						emissionStrength2 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)) + (dot(pos2, float4(0,-0.5,0,0)) * (1111.0 /*_EmissiveScroll_Interval2*/)) + _Time.x * (3.0 /*_EmissiveScroll_Velocity2*/));
						#endif
					}
					else
					{
						emissionStrength2 *= calculateScrollingEmission(float4(0,-0.5,0,0), (3.0 /*_EmissiveScroll_Velocity2*/), (1111.0 /*_EmissiveScroll_Interval2*/), (0.0 /*_EmissiveScroll_Width2*/), (0.0 /*_EmissionScrollingOffset2*/), pos2);
					}
				}
				if ((0.0 /*_EmissionBlinkingEnabled2*/))
				{
					emissionStrength2 *= calculateBlinkingEmission((-20.0 /*_EmissiveBlink_Min2*/), (20.0 /*_EmissiveBlink_Max2*/), (4.0 /*_EmissiveBlink_Velocity2*/), (4.0 /*_EmissionBlinkingOffset2*/));
				}
				...
				#if defined(PROP_EMISSIONMASK2) || !defined(OPTIMIZER_ENABLED)
				float emissionMask2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMask2UV*/)], float4(1,1,0,0)) + _Time.x * float4(0,0,0,0))[(2.0 /*_EmissionMask2Channel*/)];
				#else
