Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/c3ac9be246369af4c9b83d50e3ed5e96"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + -0.15);
				if (0.0 > 0)
				{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[5.0].xy, float4(0.1,0.1,0,0));
				if (0.0)
				{
