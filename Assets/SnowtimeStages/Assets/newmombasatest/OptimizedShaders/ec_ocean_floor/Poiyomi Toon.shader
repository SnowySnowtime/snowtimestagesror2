Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/c3ac9be246369af4c9b83d50e3ed5e96"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.15 /*_AlphaMod*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(5.0 /*_MainTexUV*/)].xy, float4(0.1,0.1,0,0));
