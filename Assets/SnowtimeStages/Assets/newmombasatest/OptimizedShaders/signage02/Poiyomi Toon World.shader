Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/fecf66694e340e44abf953fa457931e2"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission__1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0__1 = emissionTex__1.rgb * lerp(1, poiFragData.baseColor, mixBaseColor__1).rgb * poiThemeColor(poiMods, float4(2,0,0,1).rgb, 0.0);
				emissionAlpha__1 = emissionTex__1.a;
				#else
				emissionColor0__1 = lerp(1, poiFragData.baseColor, mixBaseColor__1).rgb * poiThemeColor(poiMods, float4(2,0,0,1).rgb, 0.0);
				#endif
			...
			float3 applyEmission__2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if (1.0)
				{
					emissionStrength0__2 *= calculateBlinkingEmission__2(-2.0, 2.0, 4.0, 0.0);
				}
				if(0.0)
				{
