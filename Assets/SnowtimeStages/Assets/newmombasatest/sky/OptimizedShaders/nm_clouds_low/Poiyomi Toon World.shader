Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/88614042fca36ac47a394e3e37ca7cce"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (0.25 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (1.0 /*_DetailTexIntensity*/));
			}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, mainUV, float4(0.25,0.25,0,0), (1.0 /*_MainTexStochastic*/));
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
