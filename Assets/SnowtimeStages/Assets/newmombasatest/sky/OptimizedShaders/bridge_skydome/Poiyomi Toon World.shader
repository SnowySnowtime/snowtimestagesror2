Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/28e584b9345ff0e42b9f071cbd683e61"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (0.0)
				{
					mainUV = sharpSample(float4(0.00390625,0.015625,256,64), mainUV);
				}
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.5775805,0.5775805,0.5775805,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.5775805,0.5775805,0.5775805,1).a;
				#else
