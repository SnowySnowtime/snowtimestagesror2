Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ee1aba821e9df7a46a1c37eda7080088"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionStrength0 *= calculateBlinkingEmission((-6400.0 /*_EmissiveBlink_Min*/), (32.0 /*_EmissiveBlink_Max*/), (1.0 /*_EmissiveBlink_Velocity*/), (4.0 /*_EmissionBlinkingOffset*/));
				}
