Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/3932c4a92b2ad404a9c0c44c8b415b13"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[0.0], float4(2,2,0,0)), float4(0,0,0,0), 1.0).rgb * poiThemeColor(poiMods, float4(1,1,1,1), 0.0);
				#else
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.5600193,0.5600193,0.5600193,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.5600193,0.5600193,0.5600193,1).a;
				#else
