Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/674c69e6ae84f484ba3a468668366c39"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				#ifdef POI_AUDIOLINK
				if (AudioLinkIsAvailable() && (0.0 /*_VertexAudioLinkEnabled*/) && (1.0 /*_AudioLinkAnimToggle*/))
				{
				...
				#endif
				float4 rotation = float4(float4(0,-73.5,0,1).xyz + float3(180, 0, 0) + float4(0,0,0,1) * _Time.x + ALrotation + CTALRotation, float4(0,-73.5,0,1).w);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					percepRough = GSAA_Filament(poiMesh.normals[(0.0 /*_PBRNormalSelect*/)], percepRough, (0.15 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					if ((0.0 /*_Specular2ndLayer*/) == 1 && (1.0 /*_MochieSpecularStrength2*/) > 0)
					{
						percepRough2 = GSAA_Filament(poiMesh.normals[(0.0 /*_PBRNormalSelect*/)], percepRough2, (0.15 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					}
				}
				...
				float pbrNDotL = lerp(poiLight.vertexNDotL, poiLight.nDotL, (0.0 /*_PBRNormalSelect*/));
				float pbrNDotV = lerp(poiLight.vertexNDotV, poiLight.nDotV, (0.0 /*_PBRNormalSelect*/));
				float pbrNDotH = lerp(poiLight.vertexNDotH, poiLight.nDotH, (0.0 /*_PBRNormalSelect*/));
				float3 pbrReflectionDir = lerp(poiCam.vertexReflectionDir, poiCam.reflectionDir, (0.0 /*_PBRNormalSelect*/));
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						fresnelTerm = 1;
						specularTerm = 1;
						float pbrVDotNL = lerp(poiLight.vertexVDotNL[index], poiLight.vDotNL[index], (0.0 /*_PBRNormalSelect*/));
						float pbrVDotNH = lerp(poiLight.vertexVDotNH[index], poiLight.vDotNH[index], (0.0 /*_PBRNormalSelect*/));
				...
				{
					reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, pbrNDotV), (0.0 /*_RefSpecFresnel*/));
				}
				else
				{
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_ClearCoatGSAAEnabled*/))
				{
					percepRough = GSAA_Filament(poiMesh.normals[(0.0 /*_ClearCoatNormalSelect*/)], percepRough, (0.0 /*_ClearCoatGSAAVariance*/), (0.0 /*_ClearCoatGSAAThreshold*/));
				}
				float brdfRoughness = percepRough * percepRough;
				brdfRoughness = max(brdfRoughness, 0.002);
				float3 diffuse = 0;
				...
				float3 reflections = 0;
				float3 environment = 0;
				float attenuation = min(poiLight.nDotLSaturated, lerp(poiLight.attenuation, 1, (1.0 /*_CCIgnoreCastedShadows*/)));
				float3 fresnelTerm = 1;
				float3 specularTerm = 1;
				...
				float surfaceReduction = (1.0 / (brdfRoughness * brdfRoughness + 1.0));
				float grazingTerm = saturate(smoothness + (1 - omr));
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (1.0 /*_ClearCoatForceFallback*/), (0.0 /*_ClearCoatLitFallback*/), _ClearCoatFallback, _ClearCoatFallback_HDR, clearcoatReflectionDir);
				reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, clearcoatNDotV), (0.0 /*_ClearcoatFresnel*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((0.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(unity_LightColor[index].rgb * poiLight.vAttenuation[index], (0.0 /*_LightingAdditiveLimit*/)) : unity_LightColor[index].rgb * poiLight.vAttenuation[index];
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(_LightColor0.rgb * poiLight.attenuation, (0.0 /*_LightingAdditiveLimit*/)) : _LightColor0.rgb * poiLight.attenuation;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.5 /*_LightingAdditivePassthrough*/));
				poiLight.indirectColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(poiLight.indirectColor, (0.0 /*_LightingAdditiveLimit*/)) : poiLight.indirectColor;
				#endif
