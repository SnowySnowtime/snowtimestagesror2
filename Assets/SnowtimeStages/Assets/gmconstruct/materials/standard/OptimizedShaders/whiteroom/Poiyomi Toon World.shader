Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/8e8366ec205154848bceee6cebc4bd08"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((1.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					float2 ToonAddGradient = float2((0.0 /*_LightingAdditiveGradientStart*/), (0.0 /*_LightingAdditiveGradientEnd*/));
				...
				if ((0.0 /*_ForceFlatRampedLightmap*/))
				{
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.75 /*_EmissionStrength*/);
