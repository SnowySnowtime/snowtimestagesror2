Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/7d1003d6d5e960b42b7d3747ec7f16c6"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyGlobalMaskVertexColors(in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((1 /*_GlobalMaskVertexColorRed*/) > 0)
				{
					applyToGlobalMask(poiMods, (1 /*_GlobalMaskVertexColorRed*/) - 1, (2 /*_GlobalMaskVertexColorRedBlendType*/), vcol.r);
				}
				if ((0.0 /*_GlobalMaskVertexColorGreen*/) > 0)
				{
					applyToGlobalMask(poiMods, (0.0 /*_GlobalMaskVertexColorGreen*/) - 1, (2.0 /*_GlobalMaskVertexColorGreenBlendType*/), vcol.g);
				}
				if ((0.0 /*_GlobalMaskVertexColorBlue*/) > 0)
				{
					applyToGlobalMask(poiMods, (0.0 /*_GlobalMaskVertexColorBlue*/) - 1, (2.0 /*_GlobalMaskVertexColorBlueBlendType*/), vcol.b);
				}
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(2,2,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(0,0,0,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(0,0,0,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
			...
			{
				#if defined(PROP_DETAILMASK) || !defined(OPTIMIZER_ENABLED)
				poiMods.detailMask = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailMask, _MainTex, poiUV(poiMesh.uv[(5.0 /*_DetailMaskUV*/)], float4(0.0015,0.0015,0,0)), float4(0,0,0,0), (1.0 /*_DetailMaskStochastic*/)).rg;
				#else
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					rgbMask = POI2D_SAMPLER_PAN(_RGBMask, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RGBMaskUV*/)], float4(0.0075,0.0075,0,0)), float4(0,0,0,0));
				}
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(1,1,0.5,0.5));
