Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/3edd12603625cb84cae6c7a897c2a02d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyGlobalMaskVertexColors(in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((0 /*_GlobalMaskVertexColorLinearSpace*/))
				{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.001953125,0.0078125,512,128), mainUV);
				}
