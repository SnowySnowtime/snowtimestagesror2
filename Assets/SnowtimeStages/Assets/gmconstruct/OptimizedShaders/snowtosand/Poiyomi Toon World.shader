Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/52097a13570c93345935c7f6d7caa798"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyGlobalMaskVertexColors(in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((1 /*_GlobalMaskVertexColorLinearSpace*/))
				{
					vcol.rgb = GammaToLinearSpace(vcol.rgb);
				}
				if ((13 /*_GlobalMaskVertexColorRed*/) > 0)
				{
					applyToGlobalMask(poiMods, (13 /*_GlobalMaskVertexColorRed*/) - 1, (1 /*_GlobalMaskVertexColorRedBlendType*/), vcol.r);
				}
				if ((15 /*_GlobalMaskVertexColorGreen*/) > 0)
				{
					applyToGlobalMask(poiMods, (15 /*_GlobalMaskVertexColorGreen*/) - 1, (1 /*_GlobalMaskVertexColorGreenBlendType*/), vcol.g);
				}
				if ((13 /*_GlobalMaskVertexColorBlue*/) > 0)
				{
					applyToGlobalMask(poiMods, (13 /*_GlobalMaskVertexColorBlue*/) - 1, (1 /*_GlobalMaskVertexColorBlueBlendType*/), vcol.b);
				}
				if ((0.0 /*_GlobalMaskVertexColorAlpha*/) > 0)
				{
					applyToGlobalMask(poiMods, (0.0 /*_GlobalMaskVertexColorAlpha*/) - 1, (2.0 /*_GlobalMaskVertexColorAlphaBlendType*/), vcol.a);
				}
			}
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(8,8,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (0.75 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (1.25 /*_DetailTexIntensity*/));
			}
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#endif
				if ((16.0 /*_DetailTexGlobalMask*/) > 0)
				{
					poiMods.detailMask.r = maskBlend(poiMods.detailMask.r, poiMods.globalMask[(16.0 /*_DetailTexGlobalMask*/)-1], (2.0 /*_DetailTexGlobalMaskBlendType*/));
				}
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((9.0 /*_RgbNormalGGlobalMaskChannel*/) > 0) maskFinal.g = customBlend(maskFinal.g, poiMods.globalMask[(9.0 /*_RgbNormalGGlobalMaskChannel*/) - 1], (7.0 /*_RgbNormalGGlobalMaskBlendType*/));
				...
				#endif
				#if defined(PROP_RGBNORMALG) || !defined(OPTIMIZER_ENABLED)
				if ((0.0 /*_RgbNormalGScale*/) > 0 && (0.0 /*_RGBAGreenEnable*/))
				{
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(1,1,0.5,0.5)), float4(0,0,0,0).xy, (0.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (16.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (0.0 /*_RGBARedBlendType*/), (1.0 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(1.0 /*_RgbGreenMaskChannel*/)], (9.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (0.0 /*_RGBAGreenBlendType*/), (0.0 /*_GreenAlphaAdd*/), (0.0 /*_RGBAGreenEnable*/));
				...
				if ((0.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (0.0 /*_RGBAPBRAlphaEnabled*/))
				{
					...
					if ((0.0 /*_RGBAGreenPBRSplitMaskSample*/) && (0.0 /*_RGBAPBRGreenEnabled*/) && (0.0 /*_RGBAGreenEnable*/))
					{
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.g, (0.0 /*_RGBAGreenSmoothnessInvert*/)), rgbMask[(1.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (0.0 /*_RGBAGreenEnable*/)));
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.g, (0.0 /*_RGBAGreenMetallicInvert*/)), rgbMask[(1.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (0.0 /*_RGBAGreenEnable*/)));
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalGlobalMask = (15.0 /*_Decal0GlobalMask*/);
				Decal0.m_DecalGlobalMaskBlendType = (0.0 /*_Decal0GlobalMaskBlendType*/);
				Decal0.m_DecalApplyGlobalMaskIndex = (16.0 /*_Decal0ApplyGlobalMaskIndex*/);
				...
				Decal1.m_DecalGlobalMask = (16.0 /*_Decal1GlobalMask*/);
				...
				Decal2.m_DecalGlobalMask = (13.0 /*_Decal2GlobalMask*/);
				Decal2.m_DecalGlobalMaskBlendType = (0.0 /*_Decal2GlobalMaskBlendType*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(8,8,0.5,0.5));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4019779,0.4019779,0.4019779,1).rgb, (0.0 /*_ColorThemeIndex*/));
