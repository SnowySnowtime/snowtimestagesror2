Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/782e9bd0328e8de4784fa4ae7d103435"
{
	Properties
	{
 ...
 #define PROP_RGBNORMALR 
 #define PROP_GREENTEXTURE 
 #define PROP_RGBNORMALG 
 #define PROP_BLUETEXTURE 
 #define PROP_RGBNORMALB 
 #define PROP_RGBNORMALA 
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(88,16,0,0)), float4(4,-2,0,0), (1.0 /*_DetailNormalMapStochastic*/)), (0.03 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				float4 maskFinal = 1;
				maskFinal.r = rgbMask[(3.0 /*_RgbNormalRMaskChannel*/)];
				maskFinal.g = rgbMask[(3.0 /*_RgbNormalGMaskChannel*/)];
				maskFinal.b = rgbMask[(3.0 /*_RgbNormalBMaskChannel*/)];
				...
				#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
				if ((0.02 /*_RgbNormalRScale*/) > 0 && (1.0 /*_RGBARedEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalRUV*/)], float4(0.1,0.1,0,0)), float4(1,-0.2,0,0), (1.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRedBlendMode*/) == 0 ? (0.02 /*_RgbNormalRScale*/) : (0.02 /*_RgbNormalRScale*/) * maskFinal.r);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.r, (1.0 /*_RgbNormalRedBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALG) || !defined(OPTIMIZER_ENABLED)
				if ((0.015 /*_RgbNormalGScale*/) > 0 && (1.0 /*_RGBAGreenEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalG, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalGUV*/)], float4(0.04,0.04,0,0)), float4(1,0.5,0,0), (1.0 /*_RgbNormalGStochastic*/)), (1.0 /*_RgbNormalGreenBlendMode*/) == 0 ? (0.015 /*_RgbNormalGScale*/) : (0.015 /*_RgbNormalGScale*/) * maskFinal.g);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.g, (1.0 /*_RgbNormalGreenBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALB) || !defined(OPTIMIZER_ENABLED)
				if ((0.01 /*_RgbNormalBScale*/) > 0 && (1.0 /*_RGBABlueEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalB, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalBUV*/)], float4(0.15,0.15,0,0)), float4(-1,-1,0,0), (1.0 /*_RgbNormalBStochastic*/)), (1.0 /*_RgbNormalBlueBlendMode*/) == 0 ? (0.01 /*_RgbNormalBScale*/) : (0.01 /*_RgbNormalBScale*/) * maskFinal.b);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.b, (1.0 /*_RgbNormalBlueBlendMode*/));
				}
				#endif
				#if defined(PROP_RGBNORMALA) || !defined(OPTIMIZER_ENABLED)
				if ((0.03 /*_RgbNormalAScale*/) > 0 && (1.0 /*_RGBAAlphaEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalA, _trilinear_repeat, poiUV(poiMesh.uv[(5.0 /*_RgbNormalAUV*/)], float4(0.05,0.015,0,0)), float4(7,-2,0,0), (1.0 /*_RgbNormalAStochastic*/)), (1.0 /*_RgbNormalAlphaBlendMode*/) == 0 ? (0.03 /*_RgbNormalAScale*/) : (0.03 /*_RgbNormalAScale*/) * maskFinal.a);
					RGBABlendNormals(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.a, (1.0 /*_RgbNormalAlphaBlendMode*/));
				}
				#endif
				#endif
			}
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(50,50,0,0)), float4(-0.2,0.3,0,0).xy, (0.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				green *= POI2D_SAMPLER_PAN_STOCHASTIC(_GreenTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_GreenTextureUV*/)], float4(60,60,0,0)), float4(0.1,-0.3,0,0).xy, (0.0 /*_GreenTextureStochastic*/));
				#endif
				#if defined(PROP_BLUETEXTURE) || !defined(OPTIMIZER_ENABLED)
				blue *= POI2D_SAMPLER_PAN_STOCHASTIC(_BlueTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_BlueTextureUV*/)], float4(30,30,0,0)), float4(0,-0.15,0,0).xy, (0.0 /*_BlueTextureStochastic*/));
				#endif
				#if defined(PROP_ALPHATEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (0.0 /*_RGBARedBlendType*/), (-0.1 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbGreenMaskChannel*/)], (0.0 /*_RgbGreenGlobalMaskChannel*/), (2.0 /*_RgbGreenGlobalMaskBlendType*/), poiMods), green, (0.0 /*_RGBAGreenEmissionStrength*/), (0.0 /*_RGBAGreenBlendType*/), (-0.1 /*_GreenAlphaAdd*/), (1.0 /*_RGBAGreenEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbBlueMaskChannel*/)], (0.0 /*_RgbBlueGlobalMaskChannel*/), (2.0 /*_RgbBlueGlobalMaskBlendType*/), poiMods), blue, (0.0 /*_RGBABlueEmissionStrength*/), (0.0 /*_RGBABlueBlendType*/), (-0.1 /*_BlueAlphaAdd*/), (1.0 /*_RGBABlueEnable*/));
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(3.0 /*_RgbAlphaMaskChannel*/)], (0.0 /*_RgbAlphaGlobalMaskChannel*/), (2.0 /*_RgbAlphaGlobalMaskBlendType*/), poiMods), alpha, (0.0 /*_RGBAAlphaEmissionStrength*/), (2.0 /*_RGBAAlphaBlendType*/), (0.0 /*_AlphaAlphaAdd*/), (1.0 /*_RGBAAlphaEnable*/));
				if ((0.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (0.0 /*_RGBAPBRAlphaEnabled*/))
				{
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.g, (0.0 /*_RGBAGreenSmoothnessInvert*/)), rgbMask[(0.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/)));
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.b, (0.0 /*_RGBABlueSmoothnessInvert*/)), rgbMask[(0.0 /*_RgbBlueMaskChannel*/)] * ((0.0 /*_RGBAPBRBlueEnabled*/) && (1.0 /*_RGBABlueEnable*/)));
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.g, (0.0 /*_RGBAGreenMetallicInvert*/)), rgbMask[(0.0 /*_RgbGreenMaskChannel*/)] * ((0.0 /*_RGBAPBRGreenEnabled*/) && (1.0 /*_RGBAGreenEnable*/)));
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.b, (0.0 /*_RGBABlueMetallicInvert*/)), rgbMask[(0.0 /*_RgbBlueMaskChannel*/)] * ((0.0 /*_RGBAPBRBlueEnabled*/) && (1.0 /*_RGBABlueEnable*/)));
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.0 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
			...
			{
				float smoothness = (0.172 /*_MochieRoughnessMultiplier*/);
				...
				if ((0.0 /*_PBRSplitMaskSample*/))
				{
					...
					assignValueToVectorFromIndex(PBRMaps, (4.0 /*_MochieMetallicMapsSpecularMaskChannel*/), PBRSplitMask[(4.0 /*_MochieMetallicMapsSpecularMaskChannel*/)]);
				}
				if ((2.0 /*_MochieMetallicMapsMetallicChannel*/) < 4)
				{
					metallic *= PBRMaps[(2.0 /*_MochieMetallicMapsMetallicChannel*/)];
				}
				if ((2.0 /*_MochieMetallicMapsRoughnessChannel*/) < 4)
				{
					smoothness *= PBRMaps[(2.0 /*_MochieMetallicMapsRoughnessChannel*/)];
					smoothness2 *= PBRMaps[(2.0 /*_MochieMetallicMapsRoughnessChannel*/)];
				}
				if ((2.0 /*_MochieMetallicMapsReflectionMaskChannel*/) < 4)
				{
					reflectionMask *= PBRMaps[(2.0 /*_MochieMetallicMapsReflectionMaskChannel*/)];
				}
				if ((4.0 /*_MochieMetallicMapsSpecularMaskChannel*/) < 4)
				{
					specularMask *= PBRMaps[(4.0 /*_MochieMetallicMapsSpecularMaskChannel*/)];
				}
				#endif
				reflectionMask *= (1.0 /*_MochieReflectionStrength*/);
				specularMask *= (0.0 /*_MochieSpecularStrength*/);
				if ((1.0 /*_MochieMetallicMapInvert*/))
				{
					metallic = 1 - metallic;
				}
				...
				if ((1.0 /*_MochieReflectionMaskInvert*/))
				{
					reflectionMask = 1 - reflectionMask;
				}
				if ((1.0 /*_MochieSpecularMaskInvert*/))
				{
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((0.0 /*_MochieGSAAEnabled*/))
				{
					percepRough = GSAA_Filament(poiMesh.normals[(1.0 /*_PBRNormalSelect*/)], percepRough, (0.067 /*_PoiGSAAVariance*/), (1.0 /*_PoiGSAAThreshold*/));
					if ((0.0 /*_Specular2ndLayer*/) == 1 && (1.0 /*_MochieSpecularStrength2*/) > 0)
					{
						percepRough2 = GSAA_Filament(poiMesh.normals[(1.0 /*_PBRNormalSelect*/)], percepRough2, (0.067 /*_PoiGSAAVariance*/), (1.0 /*_PoiGSAAThreshold*/));
					}
				}
				...
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (1.0 /*_MochieForceFallback*/), (1.0 /*_MochieLitFallback*/), _MochieReflCube, _MochieReflCube_HDR, pbrReflectionDir);
				if (poiMesh.isFrontFace)
				{
					reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, pbrNDotV), (0.9 /*_RefSpecFresnel*/));
				}
				else
				{
					reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, pbrNDotV), (0.0 /*_RefSpecFresnelBack*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float alphaMask = POI2D_SAMPLER_PAN(_AlphaMask, _MainTex, poiUV(poiMesh.uv[(5.0 /*_AlphaMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy).r;
