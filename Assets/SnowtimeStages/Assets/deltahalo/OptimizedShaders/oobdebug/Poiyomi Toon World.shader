Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/fc015ee2d9790e94b939eea575937e40"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, mainUV, float4(0,10,0,0), 0.0);
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.08393916,0,0,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.08393916,0,0,1).a;
				#else
