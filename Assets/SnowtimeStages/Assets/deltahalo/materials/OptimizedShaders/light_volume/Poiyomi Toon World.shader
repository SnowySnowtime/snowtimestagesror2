Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/7fd826c74c1c2384690e824475136993"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					float3 position = (1.0 /*_AlphaDistanceFadeType*/) ? poiMesh.worldPos : poiMesh.objectPosition;
					float distanceFadeMultiplier = lerp((0.0 /*_AlphaDistanceFadeMinAlpha*/), (0.5 /*_AlphaDistanceFadeMaxAlpha*/), smoothstep((15.0 /*_AlphaDistanceFadeMin*/), (40.0 /*_AlphaDistanceFadeMax*/), distance(position, poiCam.worldPos)));
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				...
				{
					float dither = calcDither(poiCam.posScreenPixels) - (0.313 /*_AlphaDitherBias*/);
					poiFragData.alpha = saturate(poiFragData.alpha - (dither * (1 - poiFragData.alpha) * (0.373 /*_AlphaDitherGradient*/)));
				}
			}
