Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/9a63c11380fceeb4684b3b104ad05f9c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(40,10,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (1.25 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (1.0 /*_DetailTexIntensity*/));
			}
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(3,3,0,0)), float4(0,0,0,0).xy, (0.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (9.0 /*_RGBARedBlendType*/), (-0.64 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (1.0 /*_BumpMapStochastic*/)), (0.2 /*_BumpScale*/));
				#else
