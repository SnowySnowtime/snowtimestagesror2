Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/88f5e903825bb6c4590ed668439a0781"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(50,50,0,0)), float4(0,0,0,0).xy, (0.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				#if defined(PROP_ALPHATEXTURE) || !defined(OPTIMIZER_ENABLED)
				alpha *= POI2D_SAMPLER_PAN_STOCHASTIC(_AlphaTexture, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_AlphaTextureUV*/)], float4(50,50,0,0)), float4(0,0,0,0).xy, (0.0 /*_AlphaTextureStochastic*/));
				#endif
				...
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(2.0 /*_RgbBlueMaskChannel*/)], (3.0 /*_RgbBlueGlobalMaskChannel*/), (2.0 /*_RgbBlueGlobalMaskBlendType*/), poiMods), blue, (0.0 /*_RGBABlueEmissionStrength*/), (0.0 /*_RGBABlueBlendType*/), (0.0 /*_BlueAlphaAdd*/), (1.0 /*_RGBABlueEnable*/));
