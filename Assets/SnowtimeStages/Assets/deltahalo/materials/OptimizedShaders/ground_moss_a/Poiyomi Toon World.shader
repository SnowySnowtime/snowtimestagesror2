Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/2821a0e7ed52b39428e53d7c36ca9f3b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[0.0], float4(2,2,0,0)), float4(0,0,0,0), 0.0).rgb * poiThemeColor(poiMods, float4(1,1,1,1), 0.0);
				#else
