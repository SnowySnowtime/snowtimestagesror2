Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/e21f590a6a3b3fe4d9a7c3ee815e2720"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(10,10,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiFragData poiFragData)
			{
				...
				SSS.a = 1 - SSS.a;
				#endif
				float3 vLTLight = poiLight.direction + poiMesh.normals[0] * (0.0 /*_SSSDistortion*/);
				float flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), (2.8 /*_SSSSpread*/)) * (1.0 /*_SSSStrength*/);
				#ifdef UNITY_PASS_FORWARDBASE
				float3 fLT = (flTDot) * saturate(SSS.a + - 1 * (-1.0 /*_SSSThicknessMod*/));
				#else
				float3 fLT = poiLight.additiveShadow * (flTDot) * saturate(SSS.a + - 1 * (-1.0 /*_SSSThicknessMod*/));
				#endif
				#if defined(POINT) || defined(SPOT)
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0.196991,0.196991,0.196991,1) * SSS.rgb * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0.196991,0.196991,0.196991,1) * SSS.rgb * poiLight.attenuation * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
			}
			#endif
