Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/87412d90869c7a144bc8dc1048594bf3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalColor = float4(0.7681513,0.7681513,0.7681513,1);
				...
				Decal0.m_DecalEmissionStrength = (3.0 /*_DecalEmissionStrength*/);
