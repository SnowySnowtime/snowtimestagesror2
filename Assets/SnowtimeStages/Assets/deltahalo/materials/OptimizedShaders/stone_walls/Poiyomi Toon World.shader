Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/b5f2470ebaab39d46ad0c2f1ce4a94b9"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[0.0].xy, float4(2,2,0,0)), float4(0,0,0,0), 0.0), 1.0);
				#else
