Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ea4b0ec121a24cb49ba07559634950d2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					v.vertex.xz = lerp(v.vertex.xz, float3(v.vertex.xz + float2(cos(_Time.y * (2.0 /*_VertexTornadoSpeed*/) + v.vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (0.1 /*_VertexTornadoRadius*/), sin(_Time.y * (2.0 /*_VertexTornadoSpeed*/) + v.vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (0.1 /*_VertexTornadoRadius*/)), v.vertex.y), smoothstep((0.15 /*_VertexTornadoBaseHeight*/), (0.2 /*_VertexTornadoTopHeight*/), v.vertex.y));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.02 /*_Cutoff*/));
