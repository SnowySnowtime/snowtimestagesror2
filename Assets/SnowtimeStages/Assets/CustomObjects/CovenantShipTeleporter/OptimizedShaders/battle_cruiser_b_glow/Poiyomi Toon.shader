Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e88e9cf113a55ba4faaebf419d12045f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0.1019608,0.1019608,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0.1019608,0.1019608,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0.1019608,0.1019608,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMaskUV*/)], float4(4,4,0,0)) + _Time.x * float4(1,1,0,0))[(0.0 /*_EmissionMaskChannel*/)];
				#else
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (20.0 /*_EmissionStrength1*/);
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.3806188,0.2193396,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.3806188,0.2193396,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.3806188,0.2193396,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				...
				emissionColor1 = hueShift(emissionColor1, frac((0.0 /*_EmissionHueShift1*/) + (0.0 /*_EmissionHueShiftSpeed1*/) * _Time.x) * (0.0 /*_EmissionHueShiftEnabled1*/), (0.0 /*_EmissionHueShiftColorSpace1*/));
				...
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
				float emissionMask1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMask1UV*/)], float4(4,4,0,0)) + _Time.x * float4(1,1,0,0))[(0.0 /*_EmissionMask1Channel*/)];
				#else
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier2 = calculateGlowInTheDark((1.0 /*_GITDEMinLight2*/), (1.0 /*_GITDEMaxLight2*/), (0.0 /*_GITDEMinEmissionMultiplier2*/), (0.0 /*_GITDEMaxEmissionMultiplier2*/), (0.0 /*_EnableGITDEmission2*/), (0.0 /*_GITDEWorldOrMesh2*/), poiLight);
				#if defined(PROP_EMISSIONMAP2) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled2*/))
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(1,0.1019608,0.1019608,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(1,0.1019608,0.1019608,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(1,0.1019608,0.1019608,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				...
				emissionColor2 = hueShift(emissionColor2, frac((0.0 /*_EmissionHueShift2*/) + (0.0 /*_EmissionHueShiftSpeed2*/) * _Time.x) * (0.0 /*_EmissionHueShiftEnabled2*/), (0.0 /*_EmissionHueShiftColorSpace2*/));
				...
				#if defined(PROP_EMISSIONMASK2) || !defined(OPTIMIZER_ENABLED)
				float emissionMask2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMask2UV*/)], float4(4,4,0,0)) + _Time.x * float4(1,1,0,0))[(0.0 /*_EmissionMask2Channel*/)];
				#else
				float emissionMask2 = 1;
				#endif
				if ((1.0 /*_EmissionMaskInvert2*/))
				{
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.3813261,0.2195262,1,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.3813261,0.2195262,1,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.3813261,0.2195262,1,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				...
				emissionColor3 = hueShift(emissionColor3, frac((0.0 /*_EmissionHueShift3*/) + (0.0 /*_EmissionHueShiftSpeed3*/) * _Time.x) * (0.0 /*_EmissionHueShiftEnabled3*/), (0.0 /*_EmissionHueShiftColorSpace3*/));
				...
				#if defined(PROP_EMISSIONMASK3) || !defined(OPTIMIZER_ENABLED)
				float emissionMask3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMask3UV*/)], float4(4,4,0,0)) + _Time.x * float4(1,1,0,0))[(0.0 /*_EmissionMask3Channel*/)];
				#else
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((0.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = lerp(poiLight.vColor[index], dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), (1.0 /*_LightingAdditiveMonochromatic*/));
				...
				#endif
				#ifdef POI_PASS_ADD
				if (!(0.0 /*_LightingAdditiveEnable*/))
				{
				...
				poiLight.attenuationStrength = (0.0 /*_LightingAdditiveCastedShadows*/);
				...
				#endif
				poiLight.directColor = lerp(poiLight.directColor, dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), (1.0 /*_LightingAdditiveMonochromatic*/));
				poiLight.indirectColor = lerp(poiLight.indirectColor, dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)), (1.0 /*_LightingAdditiveMonochromatic*/));
				poiLight.halfDir = normalize(poiLight.direction + poiCam.viewDir);
				poiLight.nDotL = dot(poiMesh.normals[1], poiLight.direction);
				poiLight.nDotLSaturated = saturate(poiLight.nDotL);
				poiLight.nDotLNormalized = (poiLight.nDotL + 1) * 0.5;
