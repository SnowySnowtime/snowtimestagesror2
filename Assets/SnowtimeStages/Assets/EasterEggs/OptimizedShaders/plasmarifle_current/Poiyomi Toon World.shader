Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/ee36a1eb79051f44a93f79763c7de36e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISTORTIONFLOWTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector = POI2D_SAMPLER_PAN(_DistortionFlowTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DistortionFlowTextureUV*/)], float4(3,3,0,0)), float4(5,3,0,0)) * 2 - 1;
				#else
				float4 flowVector = -1;
				#endif
				#if defined(PROP_DISTORTIONFLOWTEXTURE1) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector1 = POI2D_SAMPLER_PAN(_DistortionFlowTexture1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DistortionFlowTexture1UV*/)], float4(1,1,0,0)), float4(0,5,0,0)) * 2 - 1;
				#else
				...
				#endif
				half distortionStrength = (0.5 /*_DistortionStrength*/);
				half distortionStrength1 = (10.0 /*_DistortionStrength1*/);
				#ifdef POI_AUDIOLINK
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float4 red = float4(poiThemeColor(poiMods, float4(0.05875936,0.5583763,1,1).rgb, (0.0 /*_RedColorThemeIndex*/)), float4(0.05875936,0.5583763,1,1).a);
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				red *= POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _trilinear_repeat, poiUV(poiMesh.uv[(7.0 /*_RedTextureUV*/)], float4(0.5,0.5,0,0)), float4(0,0,0,0).xy, (0.0 /*_RedTextureStochastic*/));
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (20.0 /*_RGBARedEmissionStrength*/), (0.0 /*_RGBARedBlendType*/), (1.0 /*_RedAlphaAdd*/), (1.0 /*_RGBARedEnable*/));
