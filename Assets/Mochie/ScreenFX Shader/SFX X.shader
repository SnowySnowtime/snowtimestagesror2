// By Mochie
// FOR PATRONS ONLY, REDISTRIBUTION AND RESALE ARE PROHIBITED.

Shader "Mochie/Screen FX X" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
			...
			#pragma shader_feature_local _AUDIOLINK_ON
			#pragma shader_feature_local _SOBEL_FILTER_ON
			#pragma multi_compile_instancing
			#define MAIN
			#define SFXX
			#include "SFXDefines.cginc"
		...
		Pass {
            ...
            #pragma vertex vert
            #pragma fragment frag
			#pragma shader_feature_local _ _ZOOM_ON _ZOOM_RGB_ON
