// By Mochie#8794 - FOR PATRONS ONLY

Shader "Mochie/Uber X (Outline)" {
    Properties {
		//----------------------------
		// BASE
		//----------------------------
		...
		_RefractionDissolveMask("tex", 2D) = "black" {}
    ...
    SubShader {
        ...
        Pass {
			...
			#pragma shader_feature_local _ _DISSOLVE_TEXTURE_ON _DISSOLVE_SIMPLEX_ON _DISSOLVE_GEOMETRY_ON
			...
			#pragma shader_feature_local _CLONES_ON
