Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/cb35437f4ab29234db690b5f1dd22fb4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.234 /*_HighColor_Power*/)))) * (0.183 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.551 /*_Layer2Size*/)))) * (0.143 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.234 /*_HighColor_Power*/), 5)), (1.0 /*_StylizedSpecularFeather*/)) * (0.183 /*_Layer1Strength*/);
					specMask2 += poiEdgeNonLinear(specArea, (1.0 - pow((0.551 /*_Layer2Size*/), 5)), (1.0 /*_StylizedSpecular2Feather*/)) * (0.143 /*_Layer2Strength*/);
				}
				#if defined(PROP_SET_HIGHCOLORMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.234 /*_HighColor_Power*/)))) * (0.183 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.551 /*_Layer2Size*/)))) * (0.143 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.234 /*_HighColor_Power*/), 5)), (1.0 /*_StylizedSpecularFeather*/)) * (0.183 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, poiEdgeNonLinear(specArea, (1.0 - pow((0.551 /*_Layer2Size*/), 5)), (1.0 /*_StylizedSpecular2Feather*/)) * (0.143 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						vSpecMask *= specularMask;
						if ((1.0 /*_Is_BlendAddToHiColor*/) == 1)
						{
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)) * vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/));
						}
						else
						{
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), saturate(vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/)));
						}
					}
					#endif
				}
