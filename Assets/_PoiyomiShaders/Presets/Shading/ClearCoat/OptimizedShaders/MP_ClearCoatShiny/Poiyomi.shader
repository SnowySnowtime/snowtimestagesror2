Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/6382f88be2e476c4eaedf94602a16b32"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					clearCoatMask = customBlend(reflectionMask, poiMods.globalMask[(0.0 /*_ClearCoatGlobalMask*/) - 1], (2.0 /*_ClearCoatGlobalMaskBlendType*/));
				}
