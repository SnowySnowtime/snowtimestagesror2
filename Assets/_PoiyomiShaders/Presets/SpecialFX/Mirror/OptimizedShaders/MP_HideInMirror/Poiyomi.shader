Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/5bc9ee9a1e88a4e4eafa886eda898605"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				else if ((2.0 /*_Mirror*/) != 0) // Generic (CVR, etc)
				{
					notVisible += ((2.0 /*_Mirror*/) == 1) ^ IsInMirror();
				}
