Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/a2148f1e07bda204f95afdd9b7dc1363"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyIridescence(inout PoiFragData poiFragData, PoiMesh poiMesh, PoiCam poiCam, inout PoiMods poiMods)
			{
				...
				if ((1.0 /*_IridescenceNormalToggle*/))
				{
				...
				#if defined(PROP_IRIDESCENCERAMP) || !defined(OPTIMIZER_ENABLED)
				float2 iridescencePan = float4(0,0,0,0) * _Time.x + float4(1,1,0.25,0).zw;
				#ifdef POI_AUDIOLINK
				...
				#endif
				iridescenceColor = UNITY_SAMPLE_TEX2D_SAMPLER(_IridescenceRamp, _MainTex, (1 - abs(ndotv)) * float4(1,1,0.25,0).xy + iridescencePan);
				...
				if ((0.0 /*_IridescenceMaskInvert*/) == 1)
				{
				...
				{
					iridescenceMask = maskBlend(iridescenceMask, poiMods.globalMask[(0.0 /*_IridescenceMaskGlobalMask*/)-1], (2.0 /*_IridescenceMaskGlobalMaskBlendType*/));
				}
				float emissionStrength = (0.0 /*_IridescenceEmissionStrength*/);
				float iridescenceIntensity = (2.0 /*_IridescenceIntensity*/);
				#ifdef POI_AUDIOLINK
				...
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, saturate(iridescenceColor.rgb * iridescenceIntensity), iridescenceColor.a * (1.0 /*_IridescenceReplaceBlend*/) * iridescenceMask);
				poiFragData.baseColor.rgb += saturate(iridescenceColor.rgb * iridescenceIntensity * iridescenceColor.a * (0.0 /*_IridescenceAddBlend*/) * iridescenceMask);
				...
				poiFragData.emission += saturate(iridescenceColor.rgb * (2.0 /*_IridescenceIntensity*/)) * iridescenceColor.a * iridescenceMask * emissionStrength;
			}
			#endif
