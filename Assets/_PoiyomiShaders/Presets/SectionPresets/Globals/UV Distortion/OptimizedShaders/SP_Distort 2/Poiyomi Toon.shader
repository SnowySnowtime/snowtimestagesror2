Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/36090bb300774fa4399a2e41e5dfbae8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISTORTIONFLOWTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector = POI2D_SAMPLER_PAN(_DistortionFlowTexture, _MainTex, poiUV(poiMesh.uv[0.0], float4(4,4,0,0)), float4(0,0,0,0)) * 2 - 1;
				#else
				float4 flowVector = -1;
				#endif
				#if defined(PROP_DISTORTIONFLOWTEXTURE1) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector1 = POI2D_SAMPLER_PAN(_DistortionFlowTexture1, _MainTex, poiUV(poiMesh.uv[0.0], float4(5,5,0,0)), float4(0,0,0,0)) * 2 - 1;
				#else
				...
				#endif
				half distortionStrength = 0.035;
				half distortionStrength1 = 0.05;
				#ifdef POI_AUDIOLINK
