Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/c781c4faae2a8e7478eef8c89b376f69"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISTORTIONFLOWTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector = POI2D_SAMPLER_PAN(_DistortionFlowTexture, _MainTex, poiUV(poiMesh.uv[0.0], float4(6,6,0,0)), float4(0,0,0,0)) * 2 - 1;
				#else
				float4 flowVector = -1;
				#endif
				#if defined(PROP_DISTORTIONFLOWTEXTURE1) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector1 = POI2D_SAMPLER_PAN(_DistortionFlowTexture1, _MainTex, poiUV(poiMesh.uv[0.0], float4(7,7,0,0)), float4(0,0,0,0)) * 2 - 1;
				#else
				...
				#endif
				half distortionStrength = 0.1;
				half distortionStrength1 = 0.1;
				#ifdef POI_AUDIOLINK
