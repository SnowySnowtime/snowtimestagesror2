Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/96fd1f4c49b942647b8851a0e9d7970c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				CubeMapMask = min(CubeMapMask, lerp(1, poiLight.rampedLightMap, 0.9));
