Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/20c11aecc28938d4998d41560aa967b1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, 3.0, 1.0, float4(0,0,0,0).xy, 0.0, 0.5, normal0, poiCam, poiLight, poiMesh, 1.0, matcapALD);
				if (0.0)
				{
					float mipCount0 = 9;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap, matcapMask, 0.0, 0.0, 0.0, 2.0, matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				matcapALD.matcapALEnabled = 1.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap2, matcap2Mask, 0.0, 0.0, 0.0, 2.0, matcapALD);
				#endif
				#ifdef POI_MATCAP2
				matcapALD.matcapALEnabled = 1.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				#if defined(PROP_MATCAP3) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, 3.0, 1.0, float4(0,0,0,0).xy, 0.0, 0.5, normal2, poiCam, poiLight, poiMesh, 1.0, matcapALD);
				if (0.0)
				{
					float mipCount3 = 9;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap3, matcap3Mask, 0.0, 0.0, 0.0, 2.0, matcapALD);
				#endif
				#ifdef POI_MATCAP3
				matcapALD.matcapALEnabled = 1.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4)) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, 0.0), float4(1,1,1,1).a);
				}
				#else
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap4, matcap4Mask, 0.0, 0.0, 0.0, 2.0, matcapALD);
				#endif
			}
			#endif
