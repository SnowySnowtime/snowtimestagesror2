Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/3ad1ae4010aa7124fa46fada6c006deb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap, matcapMask, 0.0, 0.8, 0.0, 2.0, matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				matcapALD.matcapALEnabled = 0.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap2, matcap2Mask, 0.0, 0.8, 0.0, 2.0, matcapALD);
				#endif
				#ifdef POI_MATCAP2
				matcapALD.matcapALEnabled = 0.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap3, matcap3Mask, 0.0, 0.8, 0.0, 2.0, matcapALD);
				#endif
				#ifdef POI_MATCAP3
				matcapALD.matcapALEnabled = 0.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.0, 0.0, 0.25, 0.25, 0.0, 0.0, matcap4, matcap4Mask, 0.0, 0.8, 0.0, 2.0, matcapALD);
				#endif
			}
			#endif
