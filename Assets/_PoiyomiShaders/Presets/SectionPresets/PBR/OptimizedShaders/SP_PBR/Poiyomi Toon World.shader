Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon World/372d7ee2fdaa3914986be8eb2b0cdd0d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (0.0)
				{
					poiLight.directColor = min(poiLight.directColor, 10.0);
					poiLight.indirectColor = min(poiLight.indirectColor, 10.0);
				}
				if (0.0)
				{
