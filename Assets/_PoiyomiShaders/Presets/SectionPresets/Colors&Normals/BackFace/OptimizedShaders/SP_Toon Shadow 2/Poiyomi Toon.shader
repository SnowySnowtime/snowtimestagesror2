Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/c80772dfa04766b48b39c957e46792c1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyBackFaceColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					float4 backFaceColor = float4(0.05780543,0.03310476,0.1328683,0.8509804);
