Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/3bbe11b74297cbd43935b332458a4e61"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyBackFaceColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					float4 backFaceColor = float4(0,0.0121098,0.09178019,0.6980392);
