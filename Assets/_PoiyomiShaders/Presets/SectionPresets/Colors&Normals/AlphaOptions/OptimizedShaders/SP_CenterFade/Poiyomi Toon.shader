Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/f317269719aab3943bb257b3ccd5df9c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if (1.0)
				{
					float holoRim = saturate(1 - smoothstep(min(0.0, 1.0), 1.0, (poiCam.vDotN)));
					holoRim = abs(lerp(1, holoRim, 0.8));
