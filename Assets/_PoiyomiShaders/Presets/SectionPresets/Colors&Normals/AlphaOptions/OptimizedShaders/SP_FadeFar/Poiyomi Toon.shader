Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/d8998f2d34f7a3c45b228d16870516e7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if (1.0)
				{
					...
					float distanceFadeMultiplier = lerp(1.0, 0.0, smoothstep(2.0, 4.0, distance(position, poiCam.worldPos)));
					if (0.0 > 0)
					{
