Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/9d3374f93cc20444ea719f89dd54fa40"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if (1.0)
				{
					...
					float distanceFadeMultiplier = lerp(0.0, 1.0, smoothstep(2.0, 4.0, distance(position, poiCam.worldPos)));
					if (0.0 > 0)
					{
