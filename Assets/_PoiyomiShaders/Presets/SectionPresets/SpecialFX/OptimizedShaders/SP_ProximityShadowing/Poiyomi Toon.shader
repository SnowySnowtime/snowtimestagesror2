Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/d3df37b475fdd45479b0245063eb32e4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (1.0)
				{
					...
					poiFragData.finalColor *= lerp(poiThemeColor(poiMods, float4(0,0,0,1).rgb, 0.0), poiThemeColor(poiMods, float4(1,1,1,1).rgb, 0.0), smoothstep(-0.05, 0.2, distance(position, poiCam.worldPos)));
					if (0.0)
					{
