Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/ab63f44b70bac8e4ab447c3fb7803125"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if (!0.0)
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[0.0], float4(1,1,0,0)), float4(0,3,0,0)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, 0.0);
				}
				else
				{
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex, poiUV(poiMesh.uv[0.0], float4(3,3,0,0)) + _Time.x * float4(0,0,0,0))[0.0];
				#else
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = 2.0;
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,0,0,0), 0.0, float4(1,1,0,0), 0.0, 0.0);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, 0.0, 0.0, float4(0,0,0,0), 0.0, 1.0);
				...
				if (!0.0)
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[0.0], float4(1,1,0,0)), float4(0,-1,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, 0.0);
				}
				else
				{
				...
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
				float emissionMask1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask1, _MainTex, poiUV(poiMesh.uv[0.0], float4(3,3,0,0)) + _Time.x * float4(1,0,0,0))[0.0];
				#else
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength2 = 2.0;
				applyALEmmissionStrength(poiMods, emissionStrength2, float4(0,0,0,0), 0.0, float4(1,1,0,0), 0.0, 0.0);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength2, 0.0, 0.0, float4(0,0,0,0), 0.0, 1.0);
				...
				if (!0.0)
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[0.0], float4(1,1,0,0)), float4(0,-2,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, 0.0);
				}
				else
				{
				...
				#if defined(PROP_EMISSIONMASK2) || !defined(OPTIMIZER_ENABLED)
				float emissionMask2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask2, _MainTex, poiUV(poiMesh.uv[0.0], float4(3,3,0,0)) + _Time.x * float4(0,1,0,0))[0.0];
				#else
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength3 = 2.0;
				applyALEmmissionStrength(poiMods, emissionStrength3, float4(0,0,0,0), 0.0, float4(1,1,0,0), 0.0, 0.0);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, 0.0, 0.0, float4(0,0,0,0), 0.0, 1.0);
				...
				if (!0.0)
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[0.0], float4(1,1,0,0)), float4(0,-3,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, 0.0);
				}
				else
				{
				...
				#if defined(PROP_EMISSIONMASK3) || !defined(OPTIMIZER_ENABLED)
				float emissionMask3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask3, _MainTex, poiUV(poiMesh.uv[0.0], float4(3,3,0,0)) + _Time.x * float4(-1,-1,0,0))[0.0];
				#else
