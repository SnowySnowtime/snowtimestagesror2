Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/875f091e17ef9e543b0d724d35217dff"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMirror(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if (inMirror && 0.0 || 0.0)
				{
					poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, mirrorTexture.rgb, 8.0), mirrorTexture.a * float4(1,1,1,1).a);
