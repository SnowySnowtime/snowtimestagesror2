Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/7a8d9f918ddd2564ca01e0bf122a1a09"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskBand = 8.0 != 0.0 ? floor(maskX * 8.0) / 8.0 : maskX;
				...
				if (0.0)
				{
					...
					if (8.0 != 0.0) audioLinkMask.b = frac(maskX * 8.0 + bandth * 0.5) < bandth ? 0.0 : audioLinkMask.b;
				}
