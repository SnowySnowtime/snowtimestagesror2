Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/dcfe7452207d2404e86c5ca30156ae5d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskBand = 4.0 != 0.0 ? floor(maskX * 4.0) / 4.0 : maskX;
				...
				if (0.0)
				{
					...
					if (4.0 != 0.0) audioLinkMask.b = frac(maskX * 4.0 + bandth * 0.5) < bandth ? 0.0 : audioLinkMask.b;
				}
