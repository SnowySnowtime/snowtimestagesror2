Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/c616aa2d7967623489243ae874323c90"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = 4.0 != 0.0 ? floor(maskY * 4.0) / 4.0 : maskY;
				...
				{
					float volumeth = 0.5;
					if (4.0 != 0.0) audioLinkMask.b = frac(maskY * 4.0) > volumeth ? 0.0 : audioLinkMask.b;
