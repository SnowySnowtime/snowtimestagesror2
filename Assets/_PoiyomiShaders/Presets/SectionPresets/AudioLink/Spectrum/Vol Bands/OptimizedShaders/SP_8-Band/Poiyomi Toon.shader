Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/be96e40be3814e84fbca071cf6782a66"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = 8.0 != 0.0 ? floor(maskY * 8.0) / 8.0 : maskY;
				...
				{
					float volumeth = 0.5;
					if (8.0 != 0.0) audioLinkMask.b = frac(maskY * 8.0) > volumeth ? 0.0 : audioLinkMask.b;
