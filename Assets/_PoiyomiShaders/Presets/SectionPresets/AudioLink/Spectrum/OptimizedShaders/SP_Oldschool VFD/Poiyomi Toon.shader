Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/34b907ecea29f974aaf32f618e246a5b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0.6514058,0.6514058,1,1).rgb * poiThemeColor(poiMods, float4(0.6514058,0.6514058,1,1).rgb, 0.0);
				float3 midColor = float4(0.6514058,0.6514058,1,1).rgb * poiThemeColor(poiMods, float4(0.6514058,0.6514058,1,1).rgb, 0.0);
				float3 highColor = float4(0.6514058,0.6514058,1,1).rgb * poiThemeColor(poiMods, float4(0.6514058,0.6514058,1,1).rgb, 0.0);
