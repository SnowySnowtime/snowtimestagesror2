Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/3f8642ecde170d8408527738fd5392f4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + 0.126);
				if (0.0 > 0)
				{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0.1328683,1,0.4745098).rgb, 0.0);
