Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/80e5451b6d4c5d147abcb49b5a25cae9"
{
	Properties
	{
		...
		[sRGBWarning]_MainColorAdjustTexture ("Mask (Expand)--{reference_properties:[_MainColorAdjustTexturePan, _MainColorAdjustTextureUV]}", 2D) = "white" { }
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.2554598,0.2554598,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0.2554598,0.2554598,1).a;
				...
				if ((1.0 /*_MainHueShiftToggle*/))
				{
					...
					{
						poiFragData.baseColor = lerp(poiFragData.baseColor, hueShift(poiFragData.baseColor, shift + (3.0 /*_MainHueShiftSpeed*/) * _Time.x), hueShiftAlpha.r);
					}
					else
					{
						poiFragData.baseColor = hueShift(poiFragData.baseColor, frac((shift - (1 - hueShiftAlpha.r) + (3.0 /*_MainHueShiftSpeed*/) * _Time.x)));
					}
				}
