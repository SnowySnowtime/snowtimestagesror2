Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/876e0e5a05f7ef545a8b9f7ef7c9b8ab"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				...
				{
					float dither = calcDither(poiCam.screenUV.xy) - (0.0 /*_AlphaDitherBias*/);
